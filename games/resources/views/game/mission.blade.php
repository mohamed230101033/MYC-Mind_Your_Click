                        ...
                        <div class="relative z-10">
                            ...
                            <div class="mt-8">
                                ...
                                <div id="social-stage1" class="social-stage active">
                                        <h3 class="text-xl font-game mb-4 text-center text-purple-300">Spot the Fake Challenge</h3>
                                        ...
                                        <div class="bg-black/30 p-6 rounded-xl border border-purple-500/30 mb-6">
                                            ...
                                            <div class="flex items-start space-x-4 mb-6 bg-purple-900/30 p-4 rounded-lg border border-purple-400/20 animate__animated animate__fadeIn">
                                                <div class="flex-shrink-0">
                                                    <div class="w-16 h-16 rounded-full bg-gradient-to-br from-purple-500 to-blue-600 flex items-center justify-center overflow-hidden border-2 border-purple-300/50 shadow-lg">
                                                ...
                                                <div class="flex-1">
                                                    <div class="bg-purple-800/40 p-3 rounded-lg rounded-tl-none relative">
                                                        <div class="absolute -left-2 top-0 w-0 h-0 border-t-8 border-r-8 border-purple-800/40 border-l-transparent"></div>
                                                        <p class="text-purple-100 text-sm font-medium" id="spot-fake-assistant-text">Hi there! I'm SocialShield! Today we'll practice spotting fake social media content. Profile Phantom creates convincing fakes to trick people, but I'll help you learn how to identify them!</p>
                                                    </div>
                                            ...
                                            <div id="spot-fake-quiz-container">
                                                <!-- Current Quiz Card -->
                                                <div id="current-quiz-card" class="bg-white/5 backdrop-blur-sm rounded-xl border border-purple-500/30 overflow-hidden">
                                                    <!-- Question Header -->
                                                    ...
                                                    <!-- Social Media Post -->
                                                <div class="p-4">
                                                        <div class="bg-white rounded-lg overflow-hidden mb-4 max-w-2xl mx-auto shadow-lg">
